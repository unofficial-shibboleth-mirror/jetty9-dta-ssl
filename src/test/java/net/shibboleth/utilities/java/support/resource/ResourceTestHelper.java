 ...
 */
public final class ResourceTestHelper implements net.shibboleth.utilities.java.support.resource.Resource {
     ...
     */
    private ResourceTestHelper(@Nonnull Resource theResource) {
    ...
    public static net.shibboleth.utilities.java.support.resource.Resource of(Resource springResource) {
        ...
        return new ResourceTestHelper(springResource);
    }
