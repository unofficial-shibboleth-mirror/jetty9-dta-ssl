...
public class AbstractIdentifiableInitializableComponentTest {
    ...
    @Test
    public void abstractIdentifiableInitializableComponentTest() throws ComponentInitializationException {
        ...
        AbstractIdentifiableComponentTest.testNullAssignment(component);
    ...
    private class MyComponent extends AbstractIdentifiableInitializableComponent implements SettableIdentifiableComponent {
