...
public class QNameSupportTest {
    ...
    @BeforeTest public void setup() throws ComponentInitializationException, SAXException, IOException, ResourceException, XMLParserException {
        ...
        Resource resource = new ClasspathResource("data/net/shibboleth/utilities/java/support/xml/qNameSupportTest.xml");
        resource.initialize();
    ...
    @Test public void testQNameToContentString() {
        Assert.assertEquals(QNameSupport.qnameToContentString(new QName(NAMESPACE_1, NAME_1, PREFIX_1)), PREFIX_1 + ":" + NAME_1);
